...
*/
var plugCubed;"undefined"!==typeof plugCubed&&plugCubed.close();
define("d2154c/e46bab",[],function(){var b,e,a;b=!1;e=/xyz/.test(function(){xyz})?/\b_super\b/:/.*/;a=function(){};a.extend=function(a){function c(){!b&&this.init&&this.init.apply(this,arguments)}var g=this.prototype;b=!0;var f=new this;b=!1;for(var k in a)a.hasOwnProperty(k)&&("function"==typeof a[k]&&"function"==typeof g[k]&&e.test(a[k])?f[k]=function(a,b){return function(){var c=this._super;this._super=g[a];var f=b.apply(this,arguments);this._super=c;return f}}(k,a[k]):f[k]=a[k]);c.prototype=f;
c.prototype.constructor=c;c.extend=arguments.callee;return c};return a});
define("d2154c/c41231/c49db9",["jquery","d2154c/e46bab"],function(b,e){return e.extend({triggerHandlers:[],trigger:void 0,registered:!1,init:function(){var a;0<this.triggerHandlers.length&&this.close();this.triggerHandlers=[];if(null==this.trigger)throw Error("Missing TriggerHandler trigger!");if("string"===typeof this.trigger)this.triggerHandlers[this.trigger]=this.handler;else if(b.isArray(this.trigger))for(a in this.trigger)this.trigger.hasOwnProperty(a)&&(this.triggerHandlers[this.trigger[a]]=
"function"===typeof this[this.trigger[a]]?this[this.trigger[a]]:this.handler);else if(b.isPlainObject(this.trigger))for(a in this.trigger)this.trigger.hasOwnProperty(a)&&(this.triggerHandlers[a]=this.trigger[a])},register:function(){for(var a in this.triggerHandlers)if(this.triggerHandlers.hasOwnProperty(a))if("function"===typeof this.triggerHandlers[a])API.on(a,this.triggerHandlers[a],this);else if("function"===typeof this[this.triggerHandlers[a]])API.on(a,this[this.triggerHandlers[a]],this);this.registered=
!0},close:function(){for(var a in this.triggerHandlers)this.triggerHandlers.hasOwnProperty(a)&&("function"===typeof this.triggerHandlers[a]?(API.off(a,this.triggerHandlers[a],this),delete this.triggerHandlers[a]):"function"===typeof this[this.triggerHandlers[a]]&&(API.off(a,this[this.triggerHandlers[a]],this),delete this[this.triggerHandlers[a]]));this.registered=!1}})});
define("d2154c/f74646",["jquery","d2154c/e46bab"],function(b,e){var a,h,c;a={};h={};return new (e.extend({curLang:"en",defaultLoaded:!1,loaded:!1,init:function(){c=this;b.getJSON("https://d1rfegul30378.cloudfront.net/files/lang.json?_"+Date.now(),function(a){c.allLangs=a}).done(function(){1===c.allLangs.length&&API.chatLog("Error loading language informations for plugCubed",!0);c.loadDefault()}).fail(function(){API.chatLog("Error loading language informations for plugCubed",!0);c.loadDefault()})},
loadDefault:function(){b.getJSON("https://d1rfegul30378.cloudfront.net/files/langs/lang.en.json?_"+Date.now(),function(a){h=a;c.defaultLoaded=!0}).error(function(){setTimeout(function(){c.loadDefault()},500)})},load:function(e){if(this.defaultLoaded){var f=API.getUser().language;!f||"en"===f||0>this.allLangs.indexOf(f)?(a={},b.extend(!0,a,h),this.curLang="en",this.loaded=!0,"function"===typeof e&&e()):b.getJSON("https://d1rfegul30378.cloudfront.net/files/langs/lang."+f+".json?_"+Date.now(),function(k){a=
{};b.extend(!0,a,h,k);c.curLang=f;c.loaded=!0;"function"===typeof e&&e()}).error(function(){console.log("[plugÂ³] Couldn't load language file for "+f);a={};b.extend(!0,a,h);c.curLang="en";c.loaded=!0;"function"===typeof e&&e()})}else setTimeout(function(){c.load(e)},500)},i18n:function(c){var f=a,e;if(null==f||null==c)return"{"+b.makeArray(arguments).join(", ")+"}";var m=c.split(".");for(e in m)if(m.hasOwnProperty(e)){if(null==f[m[e]])return"{"+b.makeArray(arguments).join(", ")+"}";f=f[m[e]]}if(1<
arguments.length)for(e=1;e<arguments.length;e++)f=f.split("%"+e).join(arguments[e]);return f},allLangs:[{file:"en",name:"English"}]}))});var plugCubedUserData;
define("d2154c/e2f884",["d2154c/e46bab","d2154c/f74646","lang/Lang"],function(b,e,a){var h,c,g,f,k,m,p,n,t,l,q,r,u;h=function(d,a,b){if(null==d)return"";var c,f=[];$.isArray(a)&&(f=a);b&&$.isArray(b)||(b=[]);c=$("span div table tr td br br/ strong em a".split(" ").concat(b)).not(f).get();"*"===a&&(c=[]);d=d.split("&#8237;").join("&amp;#8237;").split("&#8238;").join("&amp;#8238;");return d.replace(/<\/?([a-z][a-z0-9]*)\b[^>]*>/gi,function(d,a){return-1<c.indexOf(a.toLowerCase())?d:""})};c=g=f=k=m=
p=n=t=[];l={};u=!requirejs.defined("c84be/a25d9/fde34");u||(q=require("c84be/c1f5e/a3af9/cbc3b/fa74e"),require("c84be/e6d1b/e6d87"),r=require("c84be/cfd90/a6e63"));$.getJSON("https://d1rfegul30378.cloudfront.net/titles.json",function(d){c=d.developer?d.developer:[];g=d.sponsor?d.sponsor:[];l=d.special?d.special:{};f=d.ambassador?d.ambassador:[];d.donator&&(k=d.donator.diamond?d.donator.diamond:[],m=d.donator.platinum?d.donator.platinum:[],p=d.donator.gold?d.donator.gold:[],n=d.donator.silver?d.donator.silver:
